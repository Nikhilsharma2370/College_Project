...
<html lang="en">
  ...
  <body>
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.html">Corporate Recuitment</a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <li class="nav-item cta mr-md-2"><a href="admin/admin_login.php" class="nav-link">Admin Login</a></li>
              ...
              <li class="nav-item cta mr-md-2"><a href="job-post.php" class="nav-link"><?php if (empty($name)) {
               echo $_SESSION['email'];} else{echo $name;}  ?></a></li>
                  ...
                  <div class="dropdown">
                    <img src="profile_img/<?php if(empty($img)){echo "logo.jpg";}else{echo $img;} ?>" class="img-circle dropdown-toggle" type="button" data-toggle="dropdown" alt="Cinque Terre" width="50" height="50">
