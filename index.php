            ...
            <div class="job-post-item bg-white p-4 d-block d-md-flex align-items-center">
              ...
              <div class="mb-4 mb-md-0 mr-5">
                ...
                <div class="job-post-item-body d-block d-md-flex">
                  ...
                  <div class="mr-3"><span class="icon-layers"></span> <a href="#">Salary <?php echo $row['salary']; ?></a></div>
                  <div><span class="icon-my_location"></span> <span><?php echo $row['country']; ?>,<?php echo $row['state']; ?>,<?php echo $row['city']; ?></span></div>
                </div>
                 <div class="mr-3"><span class="icon-layers"></span> <a href="#">Skills:</br>   <?php echo $row['skill']; ?></a></div>
                <details>
                    <div class="">
                <div class="">
