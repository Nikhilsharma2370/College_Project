...
if ($query) {
 echo "<h1> Profile Update Successfully !!</h1>";
	...
	echo "<h1> Some Error Try Again  !!</h1>";
}
...
$query=mysqli_query($conn,"insert into profiles(img,name,dob,number,email,user_email)value('$img','$name','$dob','$number','$email','$user_email')");
if ($query) {
