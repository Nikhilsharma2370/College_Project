...
try {
    ...
    $mail->Username   = "nishisharmatundla@gmail.com";                     //SMTP username
    $mail->Password   = 'sharmaji123';                               //SMTP password
    $mail->SMTPSecure = 'tls';            //Enable implicit TLS encryption
    $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

    //Recipients
    $mail->setFrom("abhisheksharma25801@gmail.com", 'NIKHIL SHARMA');  
    $mail->addAddress('nikhilsharmagoa@gmail.com', 'Joe User');     //Add a recipient
