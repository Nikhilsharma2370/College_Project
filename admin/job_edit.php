...
if (isset($_POST['submit'])){
  ...
  $query1= mysqli_query($conn,"update all_jobs set job_title='$job_title',des='$Description',keyword='$Keyword', country='$Country',state='$State', city='$City',category='$Category' where job_Id='$id'");
if ($query1) {
